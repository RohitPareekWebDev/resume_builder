        ...
        <div className="flex ">
          <div className={`w-1/4`} style={{ backgroundColor: "#4B6983" }}>
            ...
            <div className="mt-5 p-3">
              <label className="bg-white my-2" htmlFor="">
                Email :
              </label>
              ...
              <div className="text-white my-2">
                Budh vihar pal village jodhpur
              </div>
            </div>
          </div>
          ...
          <div className="p-3 w-3/4">
            <div>
              <p className="border-blue-500 border-b-4 pb-5">
                ...
                Laborum eius inventore blanditiis ab dolores repellendus nam id
                modi quisquam similique?
              </p>
            </div>

            <div>
              <h3 className="mt-3 font-bold text-2xl text-blue-500">
