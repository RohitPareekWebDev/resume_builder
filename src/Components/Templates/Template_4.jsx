    ...
    return (
        <div className='min-h-screen flex items-center justify-center'>
            <div className='w-1/2 h-screen m-5 p-5 shadow-white shadow-lg'>
                <div className='flex '>
                    <div className={`w-1/4`} style={{ backgroundColor: '#4B6983' }}>
                        <div className='p-10'>
                    ...
                    <div className='p-3 w-3/4'>
                        <div>
                            <p className='border-blue-500 border-b-4 pb-5'>
                        ...
                        <div>
                            <h3 className='mt-3 font-bold text-2xl text-blue-500'>Professional Experience</h3>
                            <div className='border-blue-500 border-b-4 pb-5'>
                        ...
                        <div>
                            <h3 className='mt-3 font-bold text-2xl text-blue-500'>Education</h3>
                            <div className='border-blue-500 border-b-4 pb-5'>
                        ...
                        <div>
                            <h3 className='mt-3 font-bold text-2xl text-blue-500'>Key Skills</h3>
                            <div>
                                <li>HTML</li>
                                <li>JAVASCRIPT</li>
                                <li>CSS</li>
